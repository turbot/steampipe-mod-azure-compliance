...
control "cis_v300_4_5" {
  title         = "4.5 Ensure Storage Logging is Enabled for Queue Service for 'Read', 'Write', and 'Delete' requests"
...
control "cis_v300_4_6" {
  title         = "4.6 Ensure that Shared Access Signature Tokens Expire Within an Hour"
...
control "cis_v300_4_7" {
  title         = "4.7 Ensure that 'Public Network Access' is `Disabled' for storage accounts"
...
control "cis_v300_4_8" {
  title         = "4.8 Ensure Default Network Access Rule for Storage Accounts is Set to Deny"
...
control "cis_v300_4_9" {
  title         = "4.9 Ensure 'Allow Azure services on the trusted services list to access this storage account' is Enabled for Storage Account Access"
...
control "cis_v300_4_10" {
  title         = "4.10 Ensure Private Endpoints are used to access Storage Accounts"
...
control "cis_v300_4_11" {
  title         = "4.11 Ensure Soft Delete is Enabled for Azure Containers and Blob Storage"
...
control "cis_v300_4_12" {
  title         = "4.12 Ensure Storage for Critical Data are Encrypted with Customer Managed Keys"
