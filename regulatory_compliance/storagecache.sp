locals {
  regulatory_compliance_storagecache_common_tags = {
...
control "hpc_cache_encrypted_with_cmk" {
  ...
  sql         = query.hpc_cache_encrypted_with_cmk.sql

  tags = merge(local.regulatory_compliance_storagecache_common_tags, {
