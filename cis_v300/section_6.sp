...
benchmark "cis_v300_6_2" {
  title         = "6.2 Monitoring using Activity Log Alerts"
...
benchmark "cis_v300_6_3" {
  title         = "6.3 Configuring Application Insights"
