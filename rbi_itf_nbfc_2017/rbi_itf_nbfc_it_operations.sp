benchmark "rbi_itf_nbfc_it_operations" {
  title       = "IT Operations"
  children = [
    benchmark.rbi_itf_nbfc_it_operations_4_2,
    benchmark.rbi_itf_nbfc_it_operations_4_4
  ]
...
benchmark "rbi_itf_nbfc_it_operations_4_4" {
  ...
  children = [
    benchmark.rbi_itf_nbfc_it_operations_4_4_a,
    benchmark.rbi_itf_nbfc_it_operations_4_4_b
  ]
}
