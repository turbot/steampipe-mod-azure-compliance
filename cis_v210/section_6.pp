...
benchmark "cis_v210_6" {
  ...
  children = [
    control.cis_v210_6_1,
    control.cis_v210_6_2,
    control.cis_v210_6_3,
    control.cis_v210_6_4,
    control.cis_v210_6_5,
    control.cis_v210_6_6,
    control.cis_v210_6_7
  ]
...
control "cis_v210_6_1" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_6_1.md")
...
control "cis_v210_6_2" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_6_2.md")
...
control "cis_v210_6_3" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_6_3.md")
...
control "cis_v210_6_5" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_6_5.md")
...
control "cis_v210_6_6" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_6_6.md")
...
control "cis_v210_6_7" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_6_7.md")
