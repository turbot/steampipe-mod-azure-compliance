...
This document describes _what_ desirable outcomes an organization can aspire to achieve. It
...
_Implementation Examples_ provide notional examples of concise, action-oriented steps to help
