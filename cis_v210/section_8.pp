...
benchmark "cis_v210_8" {
  ...
  children = [
    control.cis_v210_8_1,
    control.cis_v210_8_2,
    control.cis_v210_8_3,
    control.cis_v210_8_4,
    control.cis_v210_8_5,
    control.cis_v210_8_6,
    control.cis_v210_8_7,
    control.cis_v210_8_8
  ]
...
control "cis_v210_8_1" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_8_1.md")
...
control "cis_v210_8_2" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_8_2.md")
...
control "cis_v210_8_3" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_8_3.md")
...
control "cis_v210_8_5" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_8_5.md")
...
control "cis_v210_8_7" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_8_7.md")
...
control "cis_v210_8_8" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_8_8.md")
