...
control "cis_v140_3_12" {
  title         = "3.12 Ensure the 'Minimum TLS version' is set to 'Version 1.2'"
  ...
  sql           = query.storage_account_min_tls_1_2.sql
  documentation = file("./cis_v140/docs/cis_v140_3_12.md")
