...
benchmark "cis_v210_9" {
  ...
  children = [
    control.cis_v210_9_1,
    control.cis_v210_9_2,
    control.cis_v210_9_3,
...
control "cis_v210_9_1" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_9_1.md")
...
control "cis_v210_9_2" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_9_2.md")
...
control "cis_v210_9_3" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_9_3.md")
