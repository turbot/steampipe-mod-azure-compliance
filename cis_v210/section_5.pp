...
locals {
  cis_v210_5_1_common_tags = merge(local.cis_v210_5_common_tags, {
    cis_section_id = "5.1"
  })
  cis_v210_5_2_common_tags = merge(local.cis_v210_5_common_tags, {
    cis_section_id = "5.2"
  })
  cis_v210_5_3_common_tags = merge(local.cis_v210_5_common_tags, {
    cis_section_id = "5.3"
  })
}
...
benchmark "cis_v210_5" {
  ...
  children = [
    benchmark.cis_v210_5_1,
    benchmark.cis_v210_5_2,
    benchmark.cis_v210_5_3,
    control.cis_v210_5_4,
    benchmark.cis_v210_5_5
  ]
...
benchmark "cis_v210_5_1" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_1.md")
  children = [
    control.cis_v210_5_1_1,
    control.cis_v210_5_1_2,
...
control "cis_v210_5_1_2" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_1_2.md")
...
control "cis_v210_5_1_3" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_1_3.md")
...
control "cis_v210_5_1_4" {
  title         = "5.1.4 Ensure that logging for Azure Key Vault is 'Enabled'"
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_1_4.md")
...
control "cis_v210_5_1_5" {
  ...
  query         = query.manual_control
  documentation = file("./cis_v210/docs/cis_v210_5_1_5.md")
...
benchmark "cis_v210_5_2" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_2.md")
  children = [
    control.cis_v210_5_2_1,
    control.cis_v210_5_2_2,
    control.cis_v210_5_2_3,
    control.cis_v210_5_2_4,
    control.cis_v210_5_2_5,
    control.cis_v210_5_2_6,
    control.cis_v210_5_2_7,
    control.cis_v210_5_2_8,
    control.cis_v210_5_2_9,
    control.cis_v210_5_2_10
  ]
...
control "cis_v210_5_2_1" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_2_1.md")

  tags = merge(local.cis_v210_5_2_common_tags, {
    cis_item_id = "5.2.1"
    cis_level   = "1"
    cis_type    = "automated"
    service     = "Azure/Monitor"
...
control "cis_v210_5_2_2" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_2_2.md")
...
control "cis_v210_5_2_3" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_2_3.md")
...
control "cis_v210_5_2_4" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_2_4.md")
...
control "cis_v210_5_2_5" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_2_5.md")
...
control "cis_v210_5_2_6" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_2_6.md")
...
control "cis_v210_5_2_7" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_2_7.md")
...
control "cis_v210_5_2_8" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_2_8.md")
...
control "cis_v210_5_2_9" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_2_9.md")
...
control "cis_v210_5_2_10" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_2_10.md")
...
benchmark "cis_v210_5_3" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_3.md")
  children = [
    control.cis_v210_5_3_1
  ]
...
control "cis_v210_5_3_1" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_3_1.md")
...
control "cis_v210_5_4" {
  ...
  query         = query.manual_control
  documentation = file("./cis_v210/docs/cis_v210_5_4.md")
...
benchmark "cis_v210_5_5" {
  ...
  documentation = file("./cis_v210/docs/cis_v210_5_5.md")
  children = [
